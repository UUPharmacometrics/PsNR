...
residual.files <- c(file.path(files.w.dir,'summary_cwres.csv'),file.path(files.w.dir,'summary_iwres.csv'))
residual.files_1 <- c(file.path(files.w.dir,'summary_cwres_1.csv'),file.path(files.w.dir,'summary_iwres.csv'))
residual.outliers.file <- file.path(files.w.dir,'residual_outliers.csv')
residual.outliers.file.1 <- file.path(files.w.dir,'residual_outliers_1.csv')
residual.outliers.file.3 <- file.path(files.w.dir,'residual_outliers_3.csv')
residual.outliers.file.4 <- file.path(files.w.dir,'residual_outliers_4.csv')
residual.names <- c('CWRES','IWRES')

###################################     3. Make tests     ###################################
#...............................  (1) Test function histograms.cwres.iwres  ...............................
inf_list <-histograms.cwres.iwres(residual.files,residual.names,do_plot=F)
...
out_list_5 <- outlier.table(file.path(files.w.dir,'residual_outliers_not_exist.csv'))
